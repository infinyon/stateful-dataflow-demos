      ...
      data: (
        {
          ...
          customer: (if (.body.data.object.customer | type) == "string" then .body.data.object.customer else "" end),
  ...
  then
    {
      ...
      data: {
        ...
        description: .body.data.object.description,
        id: .body.data.object.id,
        invoice: (if (.body.data.object.invoice | type) == "string" then .body.data.object.invoice else "" end),
